...
<body style="background-color: #9499a5;">
    ...
    <div  id="myForm">
        <div class="card" >
                <form action="/admin/doAddRole" modelAttribute="roleBean" method="post" id="reg_form">
                <h1>Add Roles</h1>
                <br>
                <div class="form-data">
                    <div class="forms-inputs mb-4"> <span>Role</span> <input autocomplete="off" type="text" name="role" id="role"></div>
