...
<head>
  <meta charset="utf-8">
  <title>Approved Vehicle Data</title>
...
<body style="background-color: white;">
    ...
    <div id="myForm" style="display:none">
        ...
        <form name="fileform" method="post" action="/master/addVehicle" enctype="multipart/form-data">
                <h1>Add Vehicle Data to Database</h1>
                <br>
                <div class="form-data">
                    <!-- <div class="forms-inputs mb-4"> <span>ID</span> <input autocomplete="off" type="text"  name="user_id"></div> -->
                    <div class="forms-inputs mb-4"> <span>Car Company:</span> <input type="text" name="company" size="50" placeholder="Enter Your Car Company" required/></div>
                    <div class="forms-inputs mb-4"> <span>Car Model:</span>  <input type="text" name="model" size="50" placeholder="Enter Your Car Model" required/></div>
                    <div class="forms-inputs mb-4"> <span>Car Number:</span>  <input type="text" name="number" size="50" placeholder="Enter Your Car Number" required/></div>
                    <div class="forms-inputs mb-4"> <span>Car Registered State:</span>  <input type="text" name="regstate" size="50" placeholder="Enter Your Registered State" required/></div>                    
                    <div class="forms-inputs mb-4"> <span>RC Book Photo:</span> <input type="file" style="margin-top:10px" name="photo" placeholder="Upload Your Image" required/></div>
                    <div class="forms-inputs mb-4"> <span>RC Expiry Date</span>  <input type="date" name="rcexp" required/></div>
