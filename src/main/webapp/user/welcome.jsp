        ...
        <div class="col-md-7">
            <div class="card p-3 py-4">
                ...
                <div class="text-center mt-3"> <span class="bg-secondary p-1 px-4 rounded text-white">Pro</span>
                    <h5 class="mt-2 mb-0">${sessionScope.session}</h5> <span>UI/UX Designer</span>
                    <div class="px-4 mt-1">
...
<a href="/logout"><div class="buttons" align="center"> <button class="btn btn-outline-primary px-4">Click to logout</button></a>
</body>
</html>